...
class CompanyArrayAdapter(context: Context, companies: List<Company>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if(currentCompany != null) {
            ...
            rootView.targetUsd.text = String.format("%,d", currentCompany.targetUsd)
            rootView.investmentUsd.text = String.format("%,d", currentCompany.investmentUsd)
            rootView.noInvestors.text = String.format("%d", currentCompany.noInvestors)
        }
