...
class TransactionsFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onCreateView(
        ...
        // Get data passed in
        this.companyId = this.arguments?.getString(ViewConstants.ARG_COMPANY_ID, "") ?: ""
        ...
        this.binding.model = ViewModelProvider(this.requireActivity(), factory)[TransactionsViewModel::class.java]
    ...
    private fun loadData(options: ViewLoadOptions? = null) {
        ...
        this.binding.model!!.callApi(this.companyId!!, options, onComplete)
    }
}
